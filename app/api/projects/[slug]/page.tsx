// app/api/projects/[slug]/page.tsx
...
export default async function ProjectPage({ params }: { params: RouteParams }) {
  ...
  if (!project || project.published === false) return notFound()
  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        {project.cover_url  && <img src={project.cover_url}  alt="" className="rounded-lg" />}
        {project.image1_url && <img src={project.image1_url} alt="" className="rounded-lg" />}
        {project.image2_url && <img src={project.image2_url} alt="" className="rounded-lg" />}
      </div>
